...
this.renderPaths);this.sketch.unbind("pathaddpoint",this.renderPathPoint);delete this.sketch;b=true}return b},renderAll:function(){this.renderPaths();this.renderFrame()},renderFrame:function(){var a=this.sketch.frame;try{this.backContext.drawImage(a,0,0,a.width,a.height,0,0,this.width,this.height)}catch(b){}},renderPaths:function(){this.clear();this.sketch&&this.sketch.paths&&this.sketch.paths.forEach(this.renderPath,this)},renderPath:function(a){var b=a.points,c=b.length,f=d.Renderer.getControlPoints,
e=0,g;this.setPathStyle(a);if(a.points.length<3)this.renderPathPoint(a,b[c-1]);else{this.frontContext.beginPath();a=b[0];this.frontContext.normalizedMoveTo(a.x,a.y);for(e=1;e<c-1;e++){a=b[e];g=f(b[e-1],a,b[e+1]);this.frontContext.normalizedQuadraticCurveTo(g.p1.x,g.p1.y,a.x,a.y)}this.frontContext.normalizedQuadraticCurveTo(g.p2.x,g.p2.y,b[c-1].x,b[c-1].y);this.frontContext.stroke()}},renderPathPoint:function(a,b){var c=a.points[a.points.indexOf(b)-1]||{x:b.x*1.001,y:b.y*1.001};this.setPathStyle(a);
...
this.aspectRatio)/2;b.width=a.width;b.height=a.width/this.aspectRatio}else{b.left=(a.width-a.height*this.aspectRatio)/2;b.width=a.height*this.aspectRatio;b.height=a.height}this.setCanvasSize(b.width,b.height);this.setContainerSize(b.width,b.height);this.setContainerOffset(b.left,b.top)}}};d.Renderer.normalizeContext=function(a){var b=a.canvas.width,c=a.canvas.height;a.normalizedMoveTo=function(f,e){a.moveTo(f*b,e*c)};a.normalizedLineTo=function(f,e){a.lineTo(f*b,e*c)};a.normalizedQuadraticCurveTo=
function(f,e,g,j){a.quadraticCurveTo(f*b,e*c,g*b,j*c)}};d.Renderer.getControlPoints=function(a,b,c){var f=Math.sqrt(Math.pow(b.x-a.x,2)+Math.pow(b.y-a.y,2)),e=Math.sqrt(Math.pow(c.x-b.x,2)+Math.pow(c.y-b.y,2)),g=0.5*f/(f+e);f=0.5*e/(f+e);return{p1:{x:b.x-g*(c.x-a.x),y:b.y-g*(c.y-a.y)},p2:{x:b.x+f*(c.x-a.x),y:b.y+f*(c.y-a.y)}}}})(this);
